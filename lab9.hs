...
deriv a (Let' c) 
  | a == c = One
  | otherwise = Zero
deriv a (Union' rs) = Union' (map (deriv a) rs)
deriv a (Cat' []) = Zero
deriv a (Cat' (r:rs))
  | byp r = Union' [Cat' (deriv a r : rs), deriv a (Cat' rs)]
...
False
*Main> byp (Star' (Union' [Let' 'a', Let' 'b', Let' 'b']))
True
*Main> byp (Star' (Union' [Let' 'a', Let' 'b', Let' 'a', Let' 'a']))
True
*Main> byp (Star' (Union' [Let' 'a', Let' 'b', Let' 'a', Let' 'b']))
True
*Main> byp (Star' (Union' [Let' 'a', Let' 'b', Let' 'a', Let' 'b',Let' 'a',Let' 'a']))
True
*Main> byp (Star' (Union' [Let' 'a', Let' 'b', Let' 'a', Let' 'b',Let' 'a',Let' 'b']))
True
*Main> deriv 'a' Zero
Zero
*Main> deriv 'a' (Union' [Let' 'a', Let' 'b'])
Union' [One,Zero]
*Main> deriv 'a' (Cat' [Let' 'a', Let' 'b'])
Cat' [Zero,Cat' [One,Zero]]
*Main> deriv 'a' (Cat' [Let' 'a', Let' 'b', Let' 'b', Let' 'a'])
Cat' [One,Cat' [Zero,Cat' [Zero,Cat' [One,Zero]]]]
*Main> accept2 fsm "a"
False
*Main> accept2 fsm "ab"
True
*Main> accept2 fsm "aba"
False
*Main> accept2 fsm "ababb"
False
*Main> accept2 fsm "ababba"
False
*Main> accept2 fsm "ababbaba"
False
-}
